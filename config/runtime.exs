...
#
#     PHX_SERVER=true bin/neptuner start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :neptuner, NeptunerWeb.Endpoint, server: true
end

# Configures Basic Auth for Admin page access in production
...
if config_env() == :prod do
  ...
  config :neptuner, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
