defmodule Neptuner.Achievements.UserAchievementTest do
  ...
  describe "database constraints and relationships" do
    test "belongs to user" do
      ...
      loaded_user_achievement =
        Repo.get!(UserAchievement, user_achievement.id) |> Repo.preload(:user)
    ...
    test "belongs to achievement" do
      ...
      loaded_user_achievement =
        Repo.get!(UserAchievement, user_achievement.id) |> Repo.preload(:achievement)
