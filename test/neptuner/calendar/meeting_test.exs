defmodule Neptuner.Calendar.MeetingTest do
  ...
  describe "changeset/2" do
    ...
    test "validates title length constraints" do
      ...
      short_changeset = Meeting.changeset(%Meeting{}, %{
        title: "",
        scheduled_at: DateTime.utc_now()
      })
      ...
      long_changeset = Meeting.changeset(%Meeting{}, %{
        title: long_title,
        scheduled_at: DateTime.utc_now()
      })
      ...
      # Just right
      good_changeset = Meeting.changeset(%Meeting{}, %{
    ...
    test "validates duration_minutes is positive" do
      zero_duration = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
        duration_minutes: 0,
        scheduled_at: DateTime.utc_now()
      })
      ...
      negative_duration = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
        duration_minutes: -30,
        scheduled_at: DateTime.utc_now()
      })
      ...
      positive_duration = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
        duration_minutes: 30,
        scheduled_at: DateTime.utc_now()
      })
    ...
    test "validates attendee_count is non-negative" do
      negative_attendees = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
        attendee_count: -1,
        scheduled_at: DateTime.utc_now()
      })
      ...
      zero_attendees = Meeting.changeset(%Meeting{}, %{
        title: "Solo Meeting",
        attendee_count: 0,
        scheduled_at: DateTime.utc_now()
      })
      ...
      positive_attendees = Meeting.changeset(%Meeting{}, %{
        title: "Team Meeting",
        attendee_count: 5,
        scheduled_at: DateTime.utc_now()
      })
    ...
    test "validates productivity score range" do
      too_low = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
      ...
      too_high = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
      ...
      nil_score = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
    ...
    test "allows all boolean values for could_have_been_email" do
      true_changeset = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
        could_have_been_email: true,
        scheduled_at: DateTime.utc_now()
      })
      ...
      false_changeset = Meeting.changeset(%Meeting{}, %{
        title: "Meeting",
